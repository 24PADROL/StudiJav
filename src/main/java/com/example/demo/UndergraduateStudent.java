    ...
    public void getAverageGrade(){
        ...
        if (getGrades() == null  || getGrades()){
            ...
            if (sum/getGrades().size()>= 10){
                ...
                System.out.println("If " + getName() + "continues like this, he/her will pass with an average of: " + Math.round(average * 100.0) / 100.0 + ". Pull yourself together !");
            }
